...
public class SQLProductoFactura {
	 ...
	 */
	public long adicionarProductoFactura (PersistenceManager pm, long idFactura, long idProducto, int cantidad) 
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaProductoFactura() + " values (?, ?, ?)");
        q.setParameters(idFactura, idProducto, cantidad);
