...
public class SQLPromocion {
	 ...
	 */
	public long adicionarPromocion (PersistenceManager pm, long idPromocion, long idProducto, String fechaFin, String tipoPromocion, String promocion, long idSucursal)
	{
		Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaPromocion () + " values (?, ?, TO_DATE(?, 'YYYY-MM-DD'), ?, ?, ?)");
		q.setParameters(idPromocion, idProducto, fechaFin, tipoPromocion, promocion, idSucursal);
