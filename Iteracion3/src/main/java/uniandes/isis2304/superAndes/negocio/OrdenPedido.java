...
public class OrdenPedido implements VOOrdenPedido {
	...
	public OrdenPedido() {
		this.id = 0;
		this.fechaEsperadaEntrega = LocalDate.now();
	 ...
	 */
	public OrdenPedido(long id, LocalDate fechaEsperadaEntrega, LocalDate fechaEntrega, int calificacion, long idSucursal, long idProveedor) {
		this.id = id;
	 ...
	 */
	public void setFechaEsperadaEntrega(LocalDate fechaEsperadaEntrega)
	{
		this.fechaEsperadaEntrega = fechaEsperadaEntrega;
	}
