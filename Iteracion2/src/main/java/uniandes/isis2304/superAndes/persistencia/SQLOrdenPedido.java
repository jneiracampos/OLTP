...
public class SQLOrdenPedido {
	...
	/**
         ...
         */
	public long adicionarOrdenPedido (PersistenceManager pm, long idOrdenPedido, Object fechaEsperadaEntrega, Object fechaEntrega, Object calificacionServicio, long idSucursal, long idProveedor) 
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaOrdenPedido() + " values (?, ?, ?, ?, ?, ?)");
		q.setParameters(idOrdenPedido, fechaEsperadaEntrega, fechaEntrega, calificacionServicio, idSucursal, idProveedor);
		return (long) q.executeUnique();
	}

	public long finalizarOrdenPedido (PersistenceManager pm, long idOrdenPedido, Object fechaEntrega, Object calificacionServicio) 
	{
		Query q = pm.newQuery(SQL, "UPDATE " + pp.darTablaOrdenPedido() + " SET fecha_entrega = ?, calificacion = ? WHERE id = ?");
