...
public class SQLCliente {
    ...
    public long adicionarCliente (PersistenceManager pm, long id, String correo, String direccion, String tipoCliente)
    {
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaCliente() + " values (?, ?, ?,?)");
        q.setParameters(id, correo, direccion, tipoCliente);
