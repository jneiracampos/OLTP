...
class SQLUtil
{
	...
	public long [] limpiarSuperAndes (PersistenceManager pm)
	{
		...
		Query qReabastecer = pm.newQuery(SQL, "DELETE FROM " + pp.darTablaReabastecer ());
		...
		long reabastecerEliminados = (long) qReabastecer.executeUnique ();

		return new long[] {bodegaEliminados, sucursalEliminados, productoEliminados, proveedorEliminados, clienteEliminados, promocionEliminados, estanteEliminados, productoBodegaEliminados, productoSucursalEliminados, productoFacturaEliminados, facturaEliminados, acuerdoVentaEliminados, usuarioEliminados, rolEliminados, proveedorSucursalEliminados, usuarioRolEliminados, categoriaProductoEliminados, empleadoEliminados, clienteSucursalEliminados, categoriaProductoSucursalEliminados, ordenPedidoEliminados, reabastecerEliminados};
